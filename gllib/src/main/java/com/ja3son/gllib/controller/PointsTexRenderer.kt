...
import com.ja3son.gllib.entity.PointTexEntity
...
class PointsTexRenderer : BaseRenderer() {

    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        super.onSurfaceCreated(gl, config)
        entities.add(PointTexEntity(ShaderUtils.initTexture(R.drawable.flower)))
    }
