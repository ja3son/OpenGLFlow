...
import com.ja3son.gllib.entity.DelaunayTriangulationEntity
...
class DelaunayTriangulationRenderer : BaseRenderer() {

    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        super.onSurfaceCreated(gl, config)
        entities.add(DelaunayTriangulationEntity(ShaderUtils.initTexture(R.drawable.flower)))
    }
