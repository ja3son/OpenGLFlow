...
class BallPhongEntity(val r: Float) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("ball_phong_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("ball_phong_fragment.glsl")
        )
    }
