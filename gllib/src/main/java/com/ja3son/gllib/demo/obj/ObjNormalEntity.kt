...
class ObjNormalEntity(private val fName: String) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("obj_normal_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("obj_normal_fragment.glsl")
        )
    }
