...
class RefractionEntity(private val fName: String) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("refraction_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("refraction_fragment.glsl")
        )
    }
