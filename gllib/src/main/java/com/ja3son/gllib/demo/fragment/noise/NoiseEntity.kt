...
class NoiseEntity(private val fName: String) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("noise_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("noise_fragment.glsl")
        )
    }
