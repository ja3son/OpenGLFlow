...
class ReflectionProEntity(private val fName: String) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("reflection_pro/obj_tex_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("reflection_pro/obj_tex_fragment.glsl")
        )
    }
