...
class MoonEntity(val r: Float, val texId: Int) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("moon_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("moon_fragment.glsl")
        )
    }
    ...
    override fun initShaderParams() {
        ...
        sTexture = GLES30.glGetUniformLocation(program, "sTexture")
    }
