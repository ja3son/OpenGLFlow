...
class MBOEntity(private val r: Float) : BaseEntity() {
    ...
    private fun updateMapping(currVertex: FloatArray) {
        ...
        vertexBuffer = GLES30.glMapBufferRange(GLES30.GL_ARRAY_BUFFER, 0, currVertex.size * FLOAT_SIZE,
                GLES30.GL_MAP_WRITE_BIT or GLES30.GL_MAP_INVALIDATE_BUFFER_BIT) as ByteBuffer
    ...
    override fun initVertexData() {
        ...
        GLES30.glBufferData(GLES30.GL_ELEMENT_ARRAY_BUFFER, indices.size * FLOAT_SIZE, indexBuffer, GLES30.GL_STATIC_DRAW)
        ...
        GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER, texCoors.size * FLOAT_SIZE, texCoorBuffer, GLES30.GL_STATIC_DRAW)


        GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, vertexBufferId)
        GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER, vertices.size * FLOAT_SIZE, null, GLES30.GL_STATIC_DRAW)

        vertexBuffer = GLES30.glMapBufferRange(GLES30.GL_ARRAY_BUFFER, 0, vertices.size * FLOAT_SIZE,
                GLES30.GL_MAP_WRITE_BIT or GLES30.GL_MAP_INVALIDATE_BUFFER_BIT) as ByteBuffer
    ...
    override fun drawSelf(textureId: Int) {
        ...
        GLES30.glBindBuffer(GLES30.GL_ELEMENT_ARRAY_BUFFER, indicesBufferId)
        GLES30.glDrawElements(GLES30.GL_TRIANGLES, iCounts, GLES30.GL_UNSIGNED_INT, 0)
