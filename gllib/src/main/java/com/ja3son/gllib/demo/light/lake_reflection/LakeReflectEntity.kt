...
class LakeReflectEntity(private val fName: String) : BaseEntity() {
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("lake_reflection/shader/vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("lake_reflection/shader/frag.glsl")
        )
    }
