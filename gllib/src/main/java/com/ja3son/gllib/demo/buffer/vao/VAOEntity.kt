package com.ja3son.gllib.demo.buffer.vao
...
class VAOEntity(private val fName: String) : BaseEntity() {
    ...
    private fun initVAO() {
        ...
        GLES30.glGenVertexArrays(1, vaoBufferIds, 0)
        vaoBufferId = vaoBufferIds[0]
