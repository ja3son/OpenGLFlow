...
class ShadowTexRectEntity : BaseEntity() {
    init {
        init()
    }
    ...
    override fun initVertexData() {
        ...
        val texCoor = floatArrayOf(0f, 0f, 0f, 1.0f, 1.0f, 1.0f,
                1.0f, 1.0f, 1.0f, 0f, 0f, 0f)
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("shadow_tex_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("shadow_tex_fragment.glsl")
        )
    }
