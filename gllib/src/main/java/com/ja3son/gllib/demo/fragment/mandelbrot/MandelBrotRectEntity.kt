...
class MandelBrotRectEntity : BaseEntity() {
    init {
        init()
    }
    ...
    override fun initShader() {
        program = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("mandelbrot_tex_vertex.glsl"),
                ShaderUtils.loadFromAssetsFile("mandelbrot_tex_fragment.glsl")
        )
    }
