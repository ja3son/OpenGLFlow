...
JNIEXPORT void JNICALL Java_com_ja3son_cgl_GL2JNILib_init
        (JNIEnv *, jclass, jint width, jint height) {
    setupGraphics(width, height);
}

JNIEXPORT void JNICALL Java_com_ja3son_cgl_GL2JNILib_step
        (JNIEnv *, jclass) {
    renderFrame();
}

JNIEXPORT void JNICALL Java_com_ja3son_cgl_GL2JNILib_nativeSetAssetManager
