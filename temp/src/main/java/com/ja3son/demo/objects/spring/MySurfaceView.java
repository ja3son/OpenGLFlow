...
class MySurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            mRenderer.spring.yAngle += dx * TOUCH_SCALE_FACTOR;//������y����ת�Ƕ�
            mRenderer.spring.zAngle+= dy * TOUCH_SCALE_FACTOR;//������z����ת�Ƕ�
            
            mRenderer.springl.yAngle += dx * TOUCH_SCALE_FACTOR;//������y����ת�Ƕ�
            mRenderer.springl.zAngle+= dy * TOUCH_SCALE_FACTOR;//������z����ת�Ƕ�
        }
        mPreviousY = y;//��¼���ر�λ��
        mPreviousX = x;//��¼���ر�λ��
        return true;
